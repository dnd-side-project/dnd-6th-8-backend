...
//    @Query("SELECT DISTINCT e.archives, COUNT(e.archives) FROM UserEmojiSelected e WHERE e.createdAt > :sevenDays GROUP BY e.archives ORDER BY COUNT(e.archives) DESC")
